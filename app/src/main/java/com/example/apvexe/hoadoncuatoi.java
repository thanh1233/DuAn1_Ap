...
public class hoadoncuatoi extends AppCompatActivity {
RecyclerView rcvHoaDon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hoadoncuatoi);
        ...
        nhaXeAdapter = new HoadonAdapter(hoadoncuatoi.this, R.layout.itemhoadon, hoadonArrayList);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(hoadoncuatoi.this);
    ...
    private void getLisviewDatabasefirebase() {
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (xe.getIdkhach().equals(user.getUid())) {
