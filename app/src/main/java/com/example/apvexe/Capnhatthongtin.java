                ...
                PhoneAuthOptions.newBuilder(firebaseAuth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(FirebaseException e) {
                                Toast.makeText(Capnhatthongtin.this, "Xác thực không thành công",Toast.LENGTH_SHORT).show();
                            }
...
//                        if (task.isSuccessful()) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(Capnhatthongtin.this, "Lỗi!!", Toast.LENGTH_SHORT).show();
            }
    ...
    public void deleteUser() {
        ...
        aBuilder.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                final ProgressDialog progressDialog = ProgressDialog.show(Capnhatthongtin.this,"Thông Báo","Đang đăng xuất...");
                Handler handler = new Handler();
                user.delete()
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Capnhatthongtin.this,"Đã xóa thành công",Toast.LENGTH_SHORT).show();
